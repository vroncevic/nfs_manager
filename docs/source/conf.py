...
Copyright
    ...
    nfs_manager is distributed in the hope that it will be useful, but
...
project: str = 'nfs_manager'
project_copyright: str = '2024, Vladimir Roncevic <elektron.ronca@gmail.com>'
author: str = 'Vladimir Roncevic <elektron.ronca@gmail.com>'
version: str = '2.0'
release: str = 'https://github.com/vroncevic/nfs_manager/releases'
...
htmlhelp_basename: str = 'nfs_managerdoc'
latex_elements: Dict[Any, Any] = {}
latex_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'nfs_manager.tex', 'nfs_manager Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: List[Tuple[Any, ...]] = [(
    master_doc, 'nfs_manager', 'nfs_manager Documentation', [author], 1
)]
texinfo_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'nfs_manager', 'nfs_manager Documentation', author,
    'nfs_manager', 'One line description of project.', 'Miscellaneous'
)]
